...
def conversions_request_callback(request, uri, response_headers):
    ...
    expected_url='https://api.leadsrx.com/v1/conversions.php?acctTag=thisisafaketag12&apiSecret=thisisafakeid12&conversionID=%2A&endDateTime=2021-01-30+00%3A00%3A00&landingPage=yes&startDateTime=2021-01-01+00%3A00%3A00'
    assert uri == expected_url, f'\n URL provided \n {uri} \n Did not match expected url \n {expected_url}'
...
def conversions_request_callback_for_single_visitor_id(request, uri, response_headers):
    ...
    expected_url='https://api.leadsrx.com/v1/conversions.php?acctTag=thisisafaketag12&apiSecret=thisisafakeid12&conversionID=%2A&endDateTime=2021-01-30+00%3A00%3A00&landingPage=yes&startDateTime=2021-01-01+00%3A00%3A00&visitorID=1522653355'
    assert uri == expected_url, f'\n URL provided \n {uri} \n Did not match expected url \n {expected_url}'
...
def touchpoint_request_callback(request, uri, response_headers):
    ...
    expected_url = 'https://api.leadsrx.com/v1/touchpoints.php?acctTag=thisisafaketag12&apiSecret=thisisafakeid12&campaignID=123&conversionID=%2A&endDateTime=2021-01-30+00%3A00%3A00&leadType=all&startDateTime=2021-01-01+00%3A00%3A00'
    assert uri == expected_url, f'\n URL provided \n {uri} \n Did not match expected url \n {expected_url}'
